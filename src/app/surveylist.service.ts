...
export class SurveylistService {
  ...
  listOfSurveys = [
      {id: '0', name: "Survey 1", settings: {width: '300', background: '#ffffff', font: 'Arial', fontSize: '14', resultsEmail: 'mattl@tailoredmail.com', padding: '20px 20px 20px 20px', border: 'none', borderRadius: '5px'}, questions: [{ qid: 0, label: "Label 1a", type: "select", options: {hideQuestion: false, responseRequired: false, padding: '0px 0px 0px 0px', color: '#000000', align: 'left', questionOptions: ['Hello', 'World']}}, {qid: 1, label: "Label 1b", type: "text", options: {hideQuestion: false, responseRequired: false, padding: '0px 0px 0px 0px', color: '#000000', align: 'left', borderRadius: '10px', border: 'none', placeholder: 'Hello'}}, {qid: 2, label: "Label 1b", type: "text", options: {hideQuestion: false, responseRequired: false, padding: '0px 0px 0px 0px', color: '#000000', align: 'left', borderRadius: '0px', border: 'none', placeholder: 'World'}}, {qid: 3, label: "Label 1b", type: "textarea", options: {hideQuestion: false, responseRequired: false, padding: '0px 0px 0px 0px', color: '#000000', align: 'left', borderRadius: '5px', border: 'none', placeholder: 'Hello'}}]}, 
      {id: '1', name: "Survey 2", settings: {width: '300', background: '#ffffff', font: 'Arial', fontSize: '14', resultsEmail: 'mattl@tailoredmail.com', padding: '20px 20px 20px 20px', border: 'none', borderRadius: '10px'}, questions: [{qid: 0, label: "Label 2a", type: "text", options: {hideQuestion: false, responseRequired: false, padding: '0px 10px 0px 20px', color: '#000000', align: 'left', borderRadius: '0px', border: 'none', placeholder: 'World'}}, {qid: 1, label: "Label 2b", type: "radio", options: {hideQuestion: false, responseRequired: false, padding: '10px 0px 10px 0px', color: '#000000', align: 'left', questionOptions: ['Hello', 'World']}}]}, 
      {id: '2', name: "Survey 3", settings: {width: '300', background: '#ffffff', font: 'Arial', fontSize: '14', resultsEmail: 'mattl@tailoredmail.com', padding: '20px 20px 20px 20px', border: 'none', borderRadius: '20px'}, questions: [{qid: 0, label: "Label 3a", type: "text", options: {hideQuestion: false, responseRequired: false, padding: '30px 0px 30px 0px', color: '#000000', align: 'left', borderRadius: '5px', border: 'none', placeholder: 'Hello'}}, {qid: 1, label: "Label 3b", type: "radio", options: {hideQuestion: false, responseRequired: false, padding: '0px 20px 0px 20px', color: '#000000', align: 'left', questionOptions: ['Hello', 'World']}}]}
    ];
